...
if platform.system() == "Windows":
  ...
  cdll.LoadLibrary(os.path.normpath(os.path.join(binPath, "libGmatUtild")))
  cdll.LoadLibrary(os.path.normpath(os.path.join(binPath, "libGmatBased")))
  cdll.LoadLibrary(os.path.normpath(os.path.join(binPath, "../plugins/libStationd")))
  cdll.LoadLibrary(os.path.normpath(os.path.join(binPath, "../plugins/libGmatEstimationd")))
