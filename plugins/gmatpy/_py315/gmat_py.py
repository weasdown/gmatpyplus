...
class FileManager(object):
    ...
    HELP_HTML_USING_GMAT_FILE = _gmat_py.FileManager_HELP_HTML_USING_GMAT_FILE
    HELP_HTML_TUTORIALS_FILE = _gmat_py.FileManager_HELP_HTML_TUTORIALS_FILE
    ...
    def FindPath(self, *args):
        r"""Finds file path using search order"""
...
class Interpolator(object):
    ...
    def AdjustOrderToNumPoints(self):
        return _gmat_py.Interpolator_AdjustOrderToNumPoints(self)
...
class LagrangeInterpolator(Interpolator):
    ...
    def AdjustOrderToNumPoints(self):
        return _gmat_py.LagrangeInterpolator_AdjustOrderToNumPoints(self)
...
GROUNDTRACK = _gmat_py.GROUNDTRACK
...
class StateManager(object):
    ...
    def PrepareAttitudeInfoToPublish(self, ownerNames, elementNames):
        return _gmat_py.StateManager_PrepareAttitudeInfoToPublish(self, ownerNames, elementNames)
    ...
    def PrepareAttitudeDataToPublish(self, publicData, publicDataSize, elementNames, attStartIndex, hasPrecisionTime):
        return _gmat_py.StateManager_PrepareAttitudeDataToPublish(self, publicData, publicDataSize, elementNames, attStartIndex, hasPrecisionTime)
...
class SpacePoint(GmatBase):
    ...
    def GetMJ2000State(self, *args):
        ...
        :type atTime: :py:class:`A1Mjd`
        :param atTime: Time for which the state is requested.

        :rtype: :py:class:`Rvector6`
        :return: state of the SpacePoint at time atTime.

        Notes: This method is pure virtual and must be implemented by the
...
class PhysicalModel(GmatBase):
    ...
    def GetStringArrayParameter(self, *args):
        return _gmat_py.PhysicalModel_GetStringArrayParameter(self, *args)
...
class SolarRadiationPressure(PhysicalModel):
    ...
    def GetStringArrayParameter(self, *args):
        return _gmat_py.SolarRadiationPressure_GetStringArrayParameter(self, *args)
    ...
    def GetShadowStateFromAllBodies(self, epoch, state):
        return _gmat_py.SolarRadiationPressure_GetShadowStateFromAllBodies(self, epoch, state)
...
class ICRFFile(object):
    ...
    def RotateFromICRFtoFK5(self, inState, outState, theEpoch):
        return _gmat_py.ICRFFile_RotateFromICRFtoFK5(self, inState, outState, theEpoch)

    def RotateFromFK5toICRF(self, inState, outState, theEpoch):
        return _gmat_py.ICRFFile_RotateFromFK5toICRF(self, inState, outState, theEpoch)
...
class AtmosphereModel(GmatBase):
    ...
    def SetCbJ2000CoordinateSystem(self, cs, canDelete=False):
        return _gmat_py.AtmosphereModel_SetCbJ2000CoordinateSystem(self, cs, canDelete)
...
class ExponentialAtmosphere(AtmosphereModel):
    ...
    def GetParameterText(self, id):
        return _gmat_py.ExponentialAtmosphere_GetParameterText(self, id)

    def GetParameterID(self, str):
        return _gmat_py.ExponentialAtmosphere_GetParameterID(self, str)

    def GetParameterType(self, id):
        return _gmat_py.ExponentialAtmosphere_GetParameterType(self, id)

    def GetParameterTypeString(self, id):
        return _gmat_py.ExponentialAtmosphere_GetParameterTypeString(self, id)

    def GetStringParameter(self, *args):
        return _gmat_py.ExponentialAtmosphere_GetStringParameter(self, *args)

    def SetStringParameter(self, *args):
        return _gmat_py.ExponentialAtmosphere_SetStringParameter(self, *args)
...
class PlanetaryEphem(object):
    ...
    def GetPosVel(self, *args):
        ...
        :type overrideTimeSystem: boolean, optional
...
class DeFile(PlanetaryEphem):
    ...
    def GetAnglesAndRates(self, *args):
        r"""method to return angles and rates (for Luna ONLY!!)"""
...
class ShadowState(object):
    ...
    def FindShadowState(self, state, cbSun, sunSat, sunRad, bodyRad):
        return _gmat_py.ShadowState_FindShadowState(self, state, cbSun, sunSat, sunRad, bodyRad)
...
class Spacecraft(SpaceObject):
    ...
    def GetNPlateSRPReflectance(self, *args):
        r"""Total reflectance in inertial frame"""
...
class Propagator(GmatBase):
    ...
    def RawStep(self, *args):
        r"""Method to take a raw propagation step without error control"""
...
class EphemManager(object):
    ...
    def GetIntrusionIntervals(self, instName, targetName, targetShape, targetFrame, targetNaifId, abCorrection, occultingBodyNames, minPhase, s, e, useEntireIntvl, useLightTime, stepSize, numIntervals, intervalTypes, starts, ends):
        return _gmat_py.EphemManager_GetIntrusionIntervals(self, instName, targetName, targetShape, targetFrame, targetNaifId, abCorrection, occultingBodyNames, minPhase, s, e, useEntireIntvl, useLightTime, stepSize, numIntervals, intervalTypes, starts, ends)
    ...
    def GetTargetPosition(self, epoch, targetNaifId, refFrameName, abCorrection, targPos, lightTime):
        return _gmat_py.EphemManager_GetTargetPosition(self, epoch, targetNaifId, refFrameName, abCorrection, targPos, lightTime)
    ...
    def GetPhaseAngle(self, epoch, targetNaifId, illmnNaifId, abCorrection):
        return _gmat_py.EphemManager_GetPhaseAngle(self, epoch, targetNaifId, illmnNaifId, abCorrection)
